      ...
      <div class="col-12 col-md-6 leftdescriptiondiv">
        ...
        <q-expansion-item class="collapsibleitems" label="Ingredients" dense>
          ...
          <p class="description-font insidecollapsibleitems">
            <strong>Tremella Mushroom</strong> - A natural alternative to hyaluronic acid that
            deeply hydrates and plumps the skin.
          </p>
          <p class="description-font insidecollapsibleitems">
            <strong>Vegan Collagen</strong> - Helps improve skin elasticity and reduce the
            appearance of fine lines.
          </p>
          <p class="description-font insidecollapsibleitems">
            <strong>Hibiscus Sabdariffa Flower Extract</strong> - Rich in antioxidants and natural
            acids that promote skin renewal and brightness.
          </p>
          <p class="description-font insidecollapsibleitems">
...
export default {
  ...
  data() {
    return {
      product: {
        productid: 'rosa',
        name: 'Rosa - Plump Hydrating Glow Serum',
        price: 289.0,
        discount: 0.0,
        units: 1,
        productdescription:
        ...
        howtouse: 'After cleansing apply 2-3 drops on damp skin, follow up with moisturiser',
        overalrating: 4.5,
        reviews: [
          {
            name: 'feroeskab',
            rating: 5,
            review: 'Absolutely love how hydrating this is! My skin glows all day.',
          },
          {
            name: 'lillttx',
            rating: 4,
            review: 'Very lightweight and absorbs quickly, but I wish it came in a bigger bottle!',
          },
          {
            name: 'Kulthum Khan',
            rating: 5,
            review: 'smells really good, not sticky at all',
          },
          {
            name: 'Tashreeqa A',
            rating: 4,
