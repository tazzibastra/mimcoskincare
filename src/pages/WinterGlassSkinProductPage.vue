  ...
  <q-page class="q-pa-md q-gutter-md">
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12 col-md-6 leftdescriptiondiv">
        ...
        >
          R {{ product.price }}
          <span style="text-decoration: line-through; color: #888">R 826</span>
        </p>
        <q-select
...
<script>
import product1 from '/assets/siteassets/fullset.png'
import {
  getFirestore,
  collection,
  updateDoc,
...
export default {
  ...
  data() {
    return {
      product: {
        productid: 'simplysummerbundle1',
        name: 'Winter Glass Skin',
        price: 629,
        discount: 0.0,
        productdescription:
          'This complete skincare and lip care bundle is your winter must-have — formulated to deeply hydrate, replenish, and protect against dry, flaky skin caused by harsh winter weather.',
        size: '30ml',
        arrayofimages: [
          'assets/siteassets/fullset.png',
        ...
        whyweloveit:
          '1 Simply Summer Lip Petide Treatment - Color Changing, 1 Reglow Tremella Mushroom Hydrating Moisturiser, 1 Rosa Tremella Mushroom Hydrating Serum, 1 Rekindle Cleanser + Makeup Remover',
        howtouse:
  ...
  methods: {
    ...
    updatePrice(selectedValue) {
      ...
      if (selectedOption) {
        this.product.price = 530 + selectedOption.price
      }
    },
    ...
    async handleAddToCart(product) {
      ...
      if (user) {
        ...
        const cartItem = {
          ...
          name: `${product.name} - ${this.selectedflavour}`,
