  ...
  <q-page class="q-pa-md q-gutter-md">
    <div class="row q-col-gutter-md">
      ...
      <div class="col-12 col-md-6 leftdescriptiondiv">
        ...
        <!-- <h2 class="title-font" style="line-height: 30px; font-size: 21px">SOLD OUT</h2> -->
        <p class="description-font">{{ product.productdescription }}</p>
        <p class="description-font">R {{ product.price }}</p>
        <p class="description-font">
          Size:
          <select v-model="product.size" style="width: 100px">
...
<script>
import product1 from '/assets/siteassets/tee.svg'
import {
  getFirestore,
  collection,
  updateDoc,
...
export default {
  ...
  data() {
    return {
      product: {
        ...
        price: 169.0,
        productdescription:
          'Step into your journey of self-care and healing with our empowering "In My Healing Era" T-shirt. Designed for those embracing their growth and transformation, this soft, comfortable tee serves as a reminder to prioritize mental well-being and personal growth. Whether youre taking moments to nurture your mind, body, or spirit, this shirt is more than just clothing its a statement. Wear it proudly as you honor your path toward healing, self-love, and resilience.',
        size: '',
        arrayofimages: ['/assets/siteassets/tee.svg', '/assets/siteassets/healing1.png'],
        productingredients:
        ...
        whyweloveit:
          'Works Well with Makeup – Creates a smooth base for foundation and prevents cakiness, packed with Botanicals for nourishing glowy skin',
        howtouse: 'After cleansing applu 2-3 drops on damp skin, follow up with moisturiser',
      },
  ...
  methods: {
    ...
    async handleAddToCart(product) {
      ...
      const selectedSize = product.size // Use product.size to get the selected size
      ...
      if (user) {
        ...
        const cartItem = {
          ...
          name: `${product.name} - ${selectedSize}`, // store expects 'name' (itemname in Firestore)
  ...
  mounted() {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      const newTrackingEntry = {
        ...
        pagename: 'Healing Era Product Page',
      }
