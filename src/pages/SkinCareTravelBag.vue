...
<script>
import product1 from '/assets/siteassets/tb.svg'
import {
  getFirestore,
  collection,
  updateDoc,
...
export default {
  ...
  data() {
    return {
      product: {
        productid: 'travelbag',
        name: 'Skin Care Travel Bag',
        price: 50.0,
        discount: 145.0,
        productdescription:
          'Travel in style with our sleek skincare cosmetic travel bag. Featuring a spacious front compartment, also comes with a cross bag strap,  this compact and durable bag keeps your skincare essentials organized and easily accessible, it’s perfect for trips, ensuring your beauty items stay protected and ready to use on the go.',
        size: '30ml',
        arrayofimages: ['/assets/siteassets/tb.png', '/assets/siteassets/travel2.jpg'],
        productingredients:
