      ...
      <div class="col-12 col-md-6 leftdescriptiondiv">
        ...
        <q-expansion-item class="collapsibleitems" label="Ingredients" dense>
          ...
          <p class="description-font insidecollapsibleitems">
            <strong>Tremella Mushroom</strong> - Hydrating and antioxidant-rich (natural alternative
            to hyaluronic acid)
          </p>
          <p class="description-font insidecollapsibleitems">
            <strong>Squalane</strong> - Lightweight moisturizer that mimics skin’s natural oils
          </p>
          <p class="description-font insidecollapsibleitems">
            <strong>Rosa Damascena Flower Water</strong> - Hydrating, soothing, and
            anti-inflammatory
          </p>
          <p class="description-font insidecollapsibleitems">
  ...
  data() {
    return {
      product: {
        ...
        whyweloveit:
          'Perfect for neutral to dry skin, this non-comedogenic formula deeply hydrates without clogging pores. It targets dryness and dehydration, leaving your skin feeling soft and nourished. With a light floral scent, a rich, fluffy texture, and a pale pink hue, it’s a luxurious treat for your skin.',
        howtouse:
